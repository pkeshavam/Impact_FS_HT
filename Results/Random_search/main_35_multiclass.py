...
def main():
    ...
    data_dir = "Data"
    dataset_file = "ML-EdgeIIoT-dataset_35_multiclass.csv"
    current_CSV = "35_multiclass"
    ...
    for selected_model in models.keys():
        ...
        if tuning:
            trained_model, train_times, best_hyperparameters = train_with_tuning(
                {selected_model: models_params[selected_model]}, X_train, y_train, n_iter=10  # Add n_iter for RandomizedSearchCV
            )
        else:
